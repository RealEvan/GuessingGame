...
class item1 {
	...
	Image currentImage;
	Shape hitbox;
	Image healthpotion = new Image("res/health.jpeg");
...
public class Unwavering extends BasicGameState {
	...
	private static final int SCREEN_WIDTH = 1000000000;

	private static final int SCREEN_HEIGHT = 1000000000;
	...
	throws SlickException {
		...
		grassMap = new TiledMap("res/d.tmx");
